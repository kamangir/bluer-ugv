    ...
    while True:
        ...
        if GPIO.input(ECHO) == 0:
            ...
            if GPIO.input(ECHO) == 1:
                ...
                if 0 < pulse_s < THRESH_S:
                    print(
                        f"echo detected  | pulse={pulse_ms:6.2f} ms | dist≈{distance_mm:5.0f} mm"
                    )
                else:
                    print(
                        f"no object      | pulse={pulse_ms:6.2f} ms | dist≈{distance_mm:5.0f} mm"
                    )
