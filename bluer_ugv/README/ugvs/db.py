...
dict_of_ugvs = {
    ...
    "rangin": {
        ...
        "items": [
            ...
            f"{rangin_assets2}/IMG_0033.JPG",
            f"{rangin_assets2}/IMG_0034.JPG",
            f"{rangin_assets2}/IMG_0071.JPG",
            f"{rangin_assets2}/Screenshot-2026-02-03-11-15-43.png",
            f"{rangin_assets2}/Screenshot-2026-02-03-19-46-15.png",
        ],
        "tagline": "an ad robot.",
        "class": "rangin",
        "computers": {
