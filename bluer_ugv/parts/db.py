...
db_of_parts["330-ohm"] = Part(
    ...
    images=[f"{image_prefix}/resistor.png?raw=true"],
)
...
db_of_parts["4-ch-transceiver"] = Part(
    ...
    images=f"{image_prefix}/4-channel-remote-control/view.png?raw=true",
)
...
db_of_parts["470-mF"] = Part(
    ...
    images=[f"{image_prefix}/capacitor.png?raw=true"],
)
...
db_of_parts["BTS7960"] = Part(
    ...
    images=f"{image_prefix}/bts7960.jpg?raw=true",
)
...
db_of_parts["dc-motor-12-VDC-45W"] = Part(
    ...
    images=[f"{image_prefix}/dcmotor-lres.jpg?raw=true"],
)
...
db_of_parts["LED"] = Part(
    ...
    images=[f"{image_prefix}/led.png?raw=true"],
)
...
db_of_parts["Polyfuse"] = Part(
    ...
    images=[f"{image_prefix}/polyfuse.png?raw=true"],
)
...
db_of_parts["rpi3bp"] = Part(
    ...
    images=[
        f"{image_prefix}/rpi3bplus.png?raw=true",
        f"{image_prefix}/gpio-pinout.png?raw=true",
    ],
)
...
db_of_parts["SLA-Battery"] = Part(
    ...
    images=[
        f"{image_prefix}/battery.png?raw=true",
    ],
)
...
db_of_parts["TVS-diode"] = Part(
    ...
    images=[
        f"{image_prefix}/TVSdiode.png?raw=true",
    ],
)
...
db_of_parts["XL4015"] = Part(
    ...
    images=[
        f"{image_prefix}/XL4015.png?raw=true",
    ],
)
...
db_of_parts["rpi-camera"] = Part(
    ...
    images=[
        f"{image_prefix}/rpi-camera.jpg?raw=true",
    ],
)
...
db_of_parts["2xAA-battery-holder"] = Part(
    ...
    images=[
        f"{image_prefix}/2xAA-battery-holder.jpg?raw=true",
    ],
)
...
db_of_parts["4xAA-battery-holder"] = Part(
    ...
    images=[
        f"{image_prefix}/4xAA-battery-holder.jpg?raw=true",
    ],
)
...
db_of_parts["template"] = Part(
    ...
    images=[
        f"{image_prefix}/template.jpg?raw=true",
    ],
)
