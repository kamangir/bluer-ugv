...
def test_ugvs_comparison_build():
    assert build()


def test_ugvs_comparison_list_of_feature_classes():
...
def test_ugvs_comparison_list_of_references():
...
def test_ugvs_comparison_list_of_ugvs():
