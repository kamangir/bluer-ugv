...
|   |   |   |
| --- | --- | --- |
| [`arzhang`](./bluer_ugv/docs/arzhang) [![image](https://github.com/kamangir/assets2/raw/main/arzhang/VID-20250905-WA0014_1.gif?raw=true)](./bluer_ugv/docs/arzhang) [bluer-swallow](./bluer_ugv/docs/bluer_swallow)'s little sister. | [`rangin`](./bluer_ugv/docs/rangin.md) [![image](https://github.com/kamangir/assets2/raw/main/rangin/rangin.md)](./bluer_ugv/docs/rangin.md) [bluer-swallow](./bluer_ugv/docs/bluer_swallow)'s ad robot. | [`bluer-swallow`](./bluer_ugv/docs/bluer_swallow) [![image](https://github.com/kamangir/assets2/raw/main/bluer-swallow/20250913_203635~2_1.gif?raw=true)](./bluer_ugv/docs/bluer_swallow) based on power wheels. |
| [`bluer-robin`](./bluer_ugv/docs/bluer_robin) [![image](https://github.com/kamangir/assets2/raw/main/bluer-robin/20250723_095155~2_1.gif?raw=true)](./bluer_ugv/docs/bluer_robin) remote control car kit for teenagers. | [`bluer-eagle`](./bluer_ugv/docs/bluer_eagle) [![image](https://github.com/kamangir/assets2/raw/main/bluer-eagle/file_0000000007986246b45343b0c06325dd.png?raw=true)](./bluer_ugv/docs/bluer_eagle) a remotely controlled ballon. | [`bluer-fire`](./bluer_ugv/docs/bluer_fire) [![image](https://github.com/kamangir/assets/raw/main/bluer-ugv/bluer-fire.png?raw=true)](./bluer_ugv/docs/bluer_fire) based on a used car. |
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 🐬 [`bluer_ugv-6.1116.1`](https://github.com/kamangir/bluer-ugv).
