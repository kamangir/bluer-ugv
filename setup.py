...
setup(
    ...
    packages=[
        ...
        f"{NAME}.swallow.session.classical.config",
        f"{NAME}.swallow.session.classical.controller",
        f"{NAME}.swallow.session.classical.controller.joystick",
        f"{NAME}.swallow.session.classical.controller.keyboard",
